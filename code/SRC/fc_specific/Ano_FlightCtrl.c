...
//				UARTprintf("of_flow_on\r\n");
			}
			else
			{
				switchs.of_flow_on = 0;
//				UARTprintf("of_flow_off\r\n");
			}
...
//			UARTprintf("flight_mode:ATT_STAB\r\n");
		}
		else if(CH_N[AUX1]<200)
		{
			flag.flight_mode = LOC_HOLD;
//			UARTprintf("flight_mode:LOC_HOLD\r\n");
		}
		else
		{
			flag.flight_mode = RETURN_HOME;
//			UARTprintf("flight_mode:RETURN_HOME\r\n");
		}
	}
...
////		Program_Ctrl_User_Set_HXYcmps(0,5);
//	}else
//	{
...
//	else
//		xuanting_time = 0;
//	if(xuanting_time > 10000)
//	{
////		Program_Ctrl_User_Set_HXYcmps(18,0);
//			Program_Ctrl_User_Set_YAWdps(10);
//	}
