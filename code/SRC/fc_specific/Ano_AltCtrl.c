...
////////////////
	...
	if(flag.auto_take_off_land ==AUTO_TAKE_OFF)
	{
		...
		if(take_off_ok_cnt>=8000 || (Ano_Parame.set.auto_take_off_height - loc_ctrl_2.exp[Z] <10))//(auto_ref_height>AUTO_TAKE_OFF_HEIGHT)
		{
		...
		{
			UARTprintf("AUTO_TAKE_OFF_FINISH...\r\n");
